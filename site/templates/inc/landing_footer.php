<footer class="mt-30 mb-24 flex justify-center ">
	<div class="w-full md:w-99 border-t border-blu-sa-700 flex flex-row justify-end">
		<div class="flex-grow">
		...
		<div class="mt-6 w-auto h-20">
			<div class="border-l border-blu-sa-700 text-blu-sa-700 uppercase text-xs pl-3">
